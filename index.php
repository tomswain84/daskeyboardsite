				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gy-2">
					<div class="col">
						<figure class="heading card">
							<div class="card-body">
								<img src="images/cat-mechanical_keyboards-smart_rgb.png" class="card-img" alt="Smart RGB" />
								<figcaption class="card-img-overlay">
									<h1 class="card-title">
										<small>Das Keyboard</small>
										<br>Smart RGB
									</h1>
									<a class="btn btn-outline-primary" href="#" title="View Keyboards"><span>View Keyboards<i class="fa-solid fa-plus text-red ms-4"></span></i></a>
								</figcaption>
							</div>
						</figure>
					</div>
					<div class="col">
						<figure class="heading card">
							<div class="card-body">
								<img src="images/cat-mechanical_keyboards-for_pc.png" class="card-img" alt="Smart RGB" />
								<figcaption class="card-img-overlay">
									<h1 class="card-title">
										<small>Das Keyboard</small>
										<br>For PC
					...
					<div class="col">
						<figure class="heading card">
							<div class="card-body">
								<img src="images/cat-mechanical_keyboards-for_mac.png" class="card-img" alt="Smart RGB" />
								<figcaption class="card-img-overlay">
									<h1 class="card-title">
										<small>Das Keyboard</small>
										<br>For Mac
					...
					<div class="col">
						<figure class="heading card">
							<div class="card-body">
								<img src="images/cat-mechanical_keyboards-for_linux.png" class="card-img" alt="Smart RGB" />
								<figcaption class="card-img-overlay">
									<h1 class="card-title">
										<small>Das Keyboard</small>
										<br>For Linux
					...
					<div class="col">
						<figure class="heading card">
							<div class="card-body">
								<img src="images/cat-mechanical_keyboards-backlit.png" class="card-img" alt="Smart RGB" />
								<figcaption class="card-img-overlay">
									<h1 class="card-title">
										<small>Das Keyboard</small>
										<br>Backlit
					...
					<div class="col">
						<figure class="heading card">
							<div class="card-body">
								<img src="images/cat-mechanical_keyboards-refurbished.png" class="card-img" alt="Smart RGB" />
								<figcaption class="card-img-overlay">
									<h1 class="card-title">
										<small>Das Keyboard</small>
										<br>Refurbished
				...
				<div class="row mt-xxl-5">
					<div class="col-md-6 order-md-2 d-md-flex align-items-end align-items-xxl-start">
						<figure class="heading text-center mt-5 mt-md-3 pt-md-5">
							...
							<a class="btn btn-primary" href="#" title="Read More">Read More<i class="fa-solid fa-caret-right ms-2"></i></a>
						</figure>
					</div>
