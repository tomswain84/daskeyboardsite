        	...
        	<div class="container-boxed">
        		<div class="row">
        			<div class="col">
                        ...
                        <img class="d-sm-none mt-5 breakout" src="../images/product-images/product-details/x50q/X50_4_side-m.jpg" alt="<?=$product_title?>" />
        			</div>
        		</div>
        	</div>
        </section>
        	...
        	<div class="container-boxed">
	            <div id="appletDashboard" class="row align-items-center justify-content-between">
	            	<div class="col-12 col-xl-8 col-xxl-6">
	            		<h2 class="text-red">Win at work and win in the endgame</h2>
	                ...
	                <div class="col-12 col-xl-4 col-xxl-6">
	                	<img class="img-fluid blend-plus-lighter" src="../images/product-images/product-details/x50q/dkx50q_intro.png" alt="Applet Dashboard" />
	                </div>
	            </div>
        	</div>
        </section>
				...
				<div class="row align-items-center py-5 my-md-0 border-bottom">
					<div class="col-md">
                        <figure class="heading m-0">
                            <figcaption>
                                <h2>
                                    <small>Keypress Precision</small>
					...
					<div class="col-md text-center">
						<img class="img-fluid blend-plus-lighter" src="../images/product-images/product-details/x50q/wasd-shapes-rgb.png" alt="WASD keycaps included" />
					</div>
				</div>
